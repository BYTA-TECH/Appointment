...
@RestController
@RequestMapping("/api/appointment-kafka")
public class AppointmentKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AppointmentKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AppointmentKafkaResource(KafkaProperties kafkaProperties) {
